...
export const IntroText: React.FC<{}> = () => (
  <View style={styles.content}>
    <Text style={styles.paragraph}>
      Welcome to the React Native Flipper Databases example app for React Native SQLite Storage
    </Text>
    <Text style={styles.paragraph}>
      Start adding a task using the form at the top of the screen to see how they are created in
      React Native SQLite Storage. You can also toggle the task status or remove it from the list.
    </Text>
    <Text style={styles.paragraph}>Learn more about React Native SQLite Storage at:</Text>
    <Pressable
      onPress={() => openURLInBrowser('https://github.com/andpor/react-native-sqlite-storage')}
    >
