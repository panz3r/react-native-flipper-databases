...
export const IntroText: React.FC<{}> = () => (
  <View style={styles.content}>
    ...
    <Text style={styles.paragraph}>
      ...
      they are created in WatermelonDB. You can also toggle the task status or
      remove it from the list.
    </Text>
    <Text style={styles.paragraph}>Learn more about WatermelonDB at:</Text>
    <Pressable
      onPress={() => openURLInBrowser('https://nozbe.github.io/WatermelonDB/')}
    >
      <Text style={[styles.paragraph, styles.link]}>
        nozbe.github.io/WatermelonDB/
      </Text>
    </Pressable>
  </View>
);
