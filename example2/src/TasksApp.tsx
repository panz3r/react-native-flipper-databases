...
import { RealmResultsFn, useRealm, useRealmResults } from './database/hooks';
import Task from './database/models/Task';
import colors from './styles/colors';

const tasksQueryFn: RealmResultsFn<Task> = realm => realm.objects('Task');

export function TasksApp() {
  const realm = useRealm();

  // The tasks will be set once the realm has opened and the collection has been queried.
  const tasks = useRealmResults(tasksQueryFn);
